...
app.post('/api/security-code-entry', async (req, res) => {
  try {
    ...
    // Filter by security code (case-insensitive), active status, and strict event date match.
    // We accept either UTC or local derived date from created_at, but never adjacent calendar days.
