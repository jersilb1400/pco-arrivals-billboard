...
test('location-status cache is scoped by date and response shape', () => {
  assert.match(serverSource, /buildCheckInCacheKey\(eventId,\s*\{[\s\S]*endpoint:\s*'location-status'[\s\S]*date:/);
